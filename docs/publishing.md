...
```
dist/packages/foxy-jumpscare-chrome-v0.1.0.zip     ~248 KB
dist/packages/foxy-jumpscare-firefox-v0.1.0.zip    ~248 KB
```
...
1. Register at <https://chrome.google.com/webstore/devconsole> — **$5 one-time**,
   per account.
2. New item → upload `foxy-jumpscare-chrome-v0.1.0.zip`.
